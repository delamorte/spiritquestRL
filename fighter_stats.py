...
def get_fighter_stats(name):
    ...
    if name is 'player':
        ...
        fighter_component = Fighter(
            hp=8, ac=1, ev=6, power=3, mv_spd=1.5, atk_spd=1, fov=8, abilities=["swoop", "reveal"])
    elif name is 'snake':
        fighter_component = Fighter(
            hp=12, ac=1, ev=2, power=5, mv_spd=1, atk_spd=1, fov=6, abilities=["poison bite"])
    elif name is 'frog':
        fighter_component = Fighter(
            hp=20, ac=1, ev=5, power=5, mv_spd=1.5, atk_spd=1, fov=6, abilities=["leap"])
